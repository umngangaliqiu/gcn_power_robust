...
data_x = psse_data['inputs'] #490*18528
...
split_train = int(0.8*psse_data['inputs'].shape[1]) #18528*0.8=14822  for trainning
split_val = psse_data['inputs'].shape[1] - split_train # 3706 for value
